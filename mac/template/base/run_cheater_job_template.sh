...
# command
echo "RUNNING: python run_cheater.py ${cfg_file} ${outfile_ana_temp} ${outfile_out_temp} ${input_files}" >> $logfile

# RUN
python run_cheater.py ${cfg_file} ${outfile_ana_temp} ${outfile_out_temp} ${input_files} >> $logfile 2>&1 || exit
