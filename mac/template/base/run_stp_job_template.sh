...
echo " "
echo " "
echo "python ${nue_ll_dir}/combine_rst.py ${input_pkl_file} stp_comb_df_${jobid} ." >> $logfile
python ${nue_ll_dir}/combine_rst.py ${input_pkl_file} stp_comb_df_${jobid}.pkl . >> $logfile 2>&1 || exit
echo " "
echo " "
echo " "
echo " "
